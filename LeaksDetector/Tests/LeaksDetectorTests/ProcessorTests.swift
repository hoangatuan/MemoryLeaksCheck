...
final class ProcessorTests: XCTestCase {
    ...
    func testGenerateStepsCorrectly() {
        ...
        XCTAssertTypeEqual(sut.steps[0], SimulateUIFlow.self)
        XCTAssertTypeEqual(sut.steps[1], GenerateMemgraphFile.self)
        XCTAssertTypeEqual(sut.steps[2], CheckLeaks.self)
        XCTAssertTypeEqual(sut.steps[3], DangerReportStep.self)
        XCTAssertTypeEqual(sut.steps[4], CleanUp.self)
